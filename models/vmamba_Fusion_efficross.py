...
class PatchEmbed2D(nn.Module):
    ...
    def __init__(self, patch_size=4, in_chans=272, embed_dim=96, norm_layer=None, **kwargs):
        super().__init__()
...
class VSSM_Fusion(nn.Module):
    def __init__(self, patch_size=4, in_chans=256, num_classes=1000, depths=[2, 2, 9, 2], depths_decoder=[2, 9, 2, 2],
