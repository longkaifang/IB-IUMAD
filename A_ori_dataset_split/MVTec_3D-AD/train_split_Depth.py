        ...
        for clsname in os.listdir(dataset_root):
            ...
            if clsname=="bagel":
                ...
                for split in ["train", "validation"]:
                    ...
                    # 遍历 good 和 defect 目录
                    for label_name in ["good/xyz"]: # for label_name in ["good", "defect"]
                    ...
                    # 遍历图片文件
                    for img_path in glob(os.path.join(label_dir, "*.tiff")):  # 匹配 .jpg 或 .JPG
                        # 生成相对路径
...
output_json_path = "/home/admin1/2Tsdb/lkf/uniform-3dad/dataset_split_code/MVtec3DAD_Depth_train_json/A_bagel_clsname.json"
