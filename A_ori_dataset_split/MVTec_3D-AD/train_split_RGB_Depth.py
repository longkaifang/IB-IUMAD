        ...
        for clsname in os.listdir(dataset_root):
            ...
            if clsname=="tire":
                ...
                for split in ["train", "validation"]:
                    ...
                    # 遍历 good 和 defect 目录
                    for label_name in ["good/rgb"]: # for label_name in ["good", "defect"]
                    ...
                    # 遍历图片文件
                    for img_path in glob(os.path.join(label_dir, "*.png")):  # 匹配 .jpg 或 .JPG
                        # 生成相对路径
                        xyz_path1 = img_path.replace("/rgb/", "/xyz/")
                        xyz_path = os.path.splitext(xyz_path1)[0] + ".tiff"
                        # print(xyz_path)
                        relative_path = os.path.relpath(img_path, dataset_root)
                        relative_path1 = os.path.relpath(xyz_path, dataset_root)
                        # 构造 JSON 对象
                        json_obj = {
...
output_json_path = "/home/admin1/2Tsdb/lkf/uniform-3dad/dataset_split_code/MVTec3DAD_multi_train_json/tire.json"
# output_json_path = "/home/admin1/2Tsdb/lkf/uniform-3dad/dataset_split_code/MVTec3DAD_multi_train_json/A_bagel_clsname.json"
